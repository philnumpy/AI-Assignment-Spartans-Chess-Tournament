...
def run_game(white_player_type, black_player_type, total_time_seconds=60):
    ...
    print(f"-" * 50)
    print(
        f"Starting Blitz Game: {white_player.__class__.__name__} (Depth {white_player.depth}) vs {black_player.__class__.__name__} (Depth {black_player.depth})"
    )
    print(f"-" * 50)
